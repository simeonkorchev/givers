...
public class BenchmarkTest {
    ...
    private final String BASE_URL = "http://localhost:" + serverPort;
    

    @Test
    public void benchmarkOneRequestReactive() throws Exception {
        runBenchmark(1, PARALLELISM, "/causes-nonblocking");
    }
 
    @Test
    public void benchmark8RequestReactive() throws Exception {
        runBenchmark(8, PARALLELISM, "/causes-nonblocking");
    }
        
    @Test
    public void benchmark32RequestReactive() throws Exception {
        runBenchmark(32, PARALLELISM, "/causes-nonblocking");
    }
   
    @Test
    public void benchmark96RequestReactive() throws Exception {
        runBenchmark(96, PARALLELISM, "/causes-nonblocking");
    }
 
    @Test
    public void benchmark768RequestReactive() throws Exception {
        runBenchmark(768, PARALLELISM, "/causes-nonblocking");
    }
